...
{
    [HarmonyPatch(typeof(Crop), "newDay", new[] { typeof(int), typeof(int), typeof(int), typeof(int), typeof(GameLocation) })]
    internal class Crop_newDay
    {
        /*********
        ** Protected methods
        *********/
        private static bool Prefix(Crop __instance, int state, int fertilizer, int xTile, int yTile, GameLocation environment)
        {
