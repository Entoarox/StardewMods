...
{
    class BaseItemslotComponent : BaseDynamicComponent, IItemContainer
    {
        public BaseItemslotComponent(string name, Point origin, Item item=null, int layer=0) : base(name, new Rectangle(origin.X,origin.Y,16,16), layer)
        {
