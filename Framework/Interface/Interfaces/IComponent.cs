...
namespace Entoarox.Framework.Interface
{
    ...
    {
        /// <summary>
        /// What layer this component should be on, with higher layer numbers being closer to the screen
        /// </summary>
        int Layer { get; set; }
        /// <summary>
        /// Components will only handle Update and Draw events when this value is true
        /// If this component is a <see cref="IDynamicComponent"/> or <see cref="IInputComponent"/>, those events are also disabled
        /// A <see cref="IDynamicComponent"/> will still receive the FocusLost event if it gained focus while visible
        /// </summary>
        bool Visible { get; set; }
        /// <summary>
        /// The boundary of the component in screen pixels, all values must be a multiple of <see cref="StardewValley.Game1.pixelZoom"/>
        /// </summary>
        Rectangle OuterBounds { get; set; }
        /// <summary>
        /// The name of the component, used by the IComponentCollection that holds it to allow direct access to the component
        /// </summary>
        string Name { get; }
        /// <summary>
        ...
        /// <summary>
        /// Triggers when this component is added to a collection
        ...
        /// <summary>
        /// Triggers for every draw tick that the menu this component is a part of is on the screen
        /// </summary>
