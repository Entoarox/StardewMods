...
namespace Entoarox.Framework
{
    public static class IModHelperExtensions
    {
        ...
        *********/
        ...
        /// <summary>Has Entoarox Framework perform a update check at the url given.</summary>
        ...
        /// <summary>Has Entoarox Framework perform a update check at the url given. This overload is intended for mods that need to perform update checks for non-SMAPI mods.</summary>
        /// <param name="helper">The <see cref="IModHelper" /> of the mod calling this method</param>
