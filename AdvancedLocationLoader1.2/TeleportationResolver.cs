...
namespace Entoarox.AdvancedLocationLoader
{
    internal class TeleportationResolver
    {
        ...
        private TeleportationResolver(string list)
        {
            ...
            this.Destinations = new Dictionary<string, Response>() { { "", new Response("cancel", ModEntry.Strings["cancel"]) } };
        ...
        internal void Init()
        {
            ...
            Game1.currentLocation.createQuestionDialogue(ModEntry.Strings["teleporter"], destinations.ToArray(), this.Resolver, null);
        }
