...
namespace Entoarox.Framework
{
    ...
    interface ISkill
    {
        ...
        /// <summary>
        /// Modifies how much experience per level is required as a percentage of the default
        /// </summary>
        ...
        Color Color { get; }
        /// <summary>
        /// A method that is called when the levelup menu is shown for this skill
        /// It allows you to draw the bonusses the player has gotten from this levelup
        /// </summary>
