    ...
    public class ExtendedMinecart : Mod
    {
        ...
        private void GameEvents_UpdateTick(object s, EventArgs e)
        {
            ...
            if (Config.FarmDestinationEnabled)
            {
                ...
                {
                    farm.setMapTileIndex(18, 5, 483, "Front", 1);
                    farm.setMapTileIndex(19, 5, 484, "Front", 1);
                    farm.setMapTileIndex(19, 5, 217, "Buildings", 1);
                    farm.setMapTileIndex(20, 5, 485, "Front", 1);

                    farm.setMapTileIndex(18, 6, 508, "Buildings", 1);
                    farm.setMapTileIndex(19, 6, 509, "Back", 1);
                    farm.setMapTileIndex(20, 6, 510, "Buildings", 1);

                    farm.setMapTileIndex(18, 7, 533, "Buildings", 1);
                    farm.setMapTileIndex(19, 7, 534, "Back", 1);
                    farm.setMapTileIndex(20, 7, 535, "Buildings", 1);

                    farm.setMapTileIndex(19, 6, 933, "Buildings", 1);
                    farm.setMapTile(19, 7, 958, "Buildings", "MinecartTransport", 1);
                }
                else
                {
            ...
            if (Config.DesertDestinationEnabled)
            {
                ...
                {
                    // Reset
                    desert.removeTile(34, 4, "Buildings");
                    // Backdrop
                    desert.setMapTileIndex(33, 1, 221, "Front");
                    desert.setMapTileIndex(34, 1, 222, "Front");
                    desert.setMapTileIndex(35, 1, 223, "Front");

                    desert.setMapTileIndex(33, 2, 237, "Front");
                    desert.setMapTileIndex(34, 2, 254, "Buildings");
                    desert.setMapTileIndex(34, 2, 238, "Front");
                    desert.setMapTileIndex(35, 2, 239, "Front");

                    desert.setMapTileIndex(33, 3, 253, "Buildings");
                    desert.setMapTileIndex(34, 3, 254, "Buildings");
                    desert.setMapTileIndex(35, 3, 255, "Buildings");

                    desert.setMapTileIndex(33, 4, 269, "Buildings");
                    desert.setMapTileIndex(34, 4, 270, "Back");
                    desert.setMapTileIndex(35, 4, 271, "Buildings");
                    // Cart
                    desert.setMapTileIndex(34, 3, 933, "Front", 2);
                    desert.setMapTile(34, 4, 958, "Buildings", "MinecartTransport", 2);
                }
                else
                {
                    // Reset
            ...
            if (Config.WoodsDestinationEnabled)
            {
                ...
                woods.setMapTileIndex(46, 3, 933, "Front", 1);
                woods.setMapTile(46, 4, 958, "Buildings", "MinecartTransport", 1);
            }
            if(Config.WizardDestinationEnabled)
            {
                // # Wizard
                GameLocation forest = Game1.getLocationFromName("Forest");
                forest.setMapTileIndex(13, 37, 483, "Front");
                forest.setMapTileIndex(14, 37, 484, "Front");
                forest.setMapTileIndex(14, 37, 217, "Buildings");
                forest.setMapTileIndex(15, 37, 485, "Front");

                forest.setMapTileIndex(13, 38, 508, "Buildings");
                forest.setMapTileIndex(14, 38, 509, "Back");
                forest.setMapTileIndex(15, 38, 510, "Buildings");

                forest.setMapTileIndex(13, 39, 533, "Buildings");
                forest.setMapTileIndex(15, 39, 535, "Buildings");

                forest.setMapTileIndex(14, 38, 933, "Buildings");
                forest.setMapTile(14, 39, 958, "Buildings", "MinecartTransport");
            }
            if(Config.BeachDestinationEnabled)
            {
                // # Beach
                ...
                beach.setMapTileIndex(67, 2, 933, "Buildings", 2);
                beach.setMapTile(67, 3, 958, "Buildings", "MinecartTransport", 2);
